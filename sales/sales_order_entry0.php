...
//		if(isset($_GET['age'])
		$_SESSION['Items']->delivery_address="Age: ".$_GET['age']." Y"."\nSex: ".(($_GET['sex']=='M'||$_GET['sex']=='m')? 'Male':'Female');
...
//echo 'jibon';
//echo '<iframe src="http://ac.mohonahospital.com/gl/gl_bank.php?NewDeposit=Yes"></iframe>';
end_page();
